...
<table border='1' align='center' > 
	...
	<tr><td><h5>SEC in BTC : </td><td align='center'><?php echo round(deg2rad($_POST["uid"]*0.04), 4); ?></td></tr> 
	<tr><td><h5>SEC in USD : </td><td align='center'><?php echo round(deg2rad($_POST["uid"]*400), 4); ?></td></tr> 
	<tr><td><h5>SEC in INR : </td><td align='center'><?php echo round(deg2rad($_POST["uid"]*30000), 4); ?></td></tr> 
